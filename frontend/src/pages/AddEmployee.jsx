...
function Employees() {
    ...
    const updateEMSMember = async (memberId, payload) => {
        try {
            const response = await vgtAPI.put(
                `/members/${memberId}`,
                payload
            );

            console.log(
                'EMS Member Update Response:',
                response.data
            );
            ...
            throw new Error(
                ...
                error.response?.data?.message ||
                error.message ||
                'EMS member update failed', { cause: error }
            );
        }
    };
    ...
    const updateEMSMemberPhone = async (phoneId, payload) => {
        try {
            const response = await vgtAPI.put(
                `/members_phones/${phoneId}`,
                payload
            );

            console.log(
                'EMS Phone Update Response:',
                response.data
            );
            ...
            throw new Error(
                ...
                error.response?.data?.message ||
                error.message ||
                'EMS phone update failed', { cause: error }
            );
        }
    };
    ...
    const updateEMSMemberEmail = async (emailId, payload) => {
        try {
            const response = await vgtAPI.put(
                `/members_emails/${emailId}`,
                payload
            );

            console.log(
                'EMS Email Update Response:',
                response.data
            );
            ...
            throw new Error(
                ...
                error.response?.data?.message ||
                error.message ||
                'EMS email update failed', { cause: error }
            );
        }
    };
    ...
    const deleteEMSMember = async (memberId) => {
        try {
            ...
            const response = await vgtAPI.delete(
                `/members/${memberId}`
            );

            console.log(
                'EMS Member Delete Response:',
                response.data
            );
            ...
            throw new Error(
                ...
                error.response?.data?.message ||
                error.message ||
                'EMS member deletion failed', { cause: error }
            );
        }
    };
    ...
    const deleteEMSMemberPhone = async (phoneId) => {
        try {
            ...
            throw new Error(
                ...
                error.response?.data?.message ||
                error.message ||
                'EMS phone deletion failed', { cause: error }
            );
        }
    };
    ...
    const deleteEMSMemberEmail = async (emailId) => {
        try {
            ...
            throw new Error(
                ...
                error.response?.data?.message ||
                error.message ||
                'EMS email deletion failed', { cause: error }
            );
        }
    };
            ...
            if (editingId) {
                try {
                    ...
                    const EMSUpdatePayload = {
                        ...
                        passwordhash:
                            emsEditData.member.passwordhash,
                    ...
                    const EMSPhoneUpdatePayload = {
                        ...
                        createdat:
                            emsEditData.phone.createdat,

                        id:
                            emsEditData.phone.id,

                        is_primary:
                            formData.is_primary ? 1 : 0,

                        is_sms_enabled:
                            formData.is_sms_enabled ? 1 : 0,

                        is_voice_enabled:
                            formData.is_voice_enabled ? 1 : 0,

                        is_whatsapp_enabled:
                            formData.is_whatsapp_enabled ? 1 : 0,

                        member_id: {
                            ...emsEditData.phone.member_id,

                            id:
                                emsEditData.member.id,
                    ...
                    console.log(
                        'STEP 1: Updating EMS Member...'
                    );

                    await updateEMSMember(
                        emsEditData.member.id,
                        EMSUpdatePayload
                    );

                    console.log(
                        'STEP 1 SUCCESS: EMS Member updated'
                    );
                    ...
                    console.log(
                        'STEP 2 SUCCESS: EMS Phone updated'
                    );
                    ...
                    console.log(
                        'STEP 3 SUCCESS: EMS Email updated'
                    );
                    ...
                    console.log(
                        'STEP 4: Updating local employee...'
                    );
                    ...
                    if (
                        ...
                        console.log(
                            'STEP 4 SUCCESS: Local employee updated'
                        );
                    ...
                    console.error(
                        'Employee update sequence failed:',
                        error
                    );
    ...
    const handleDelete = async (id, name) => {
        ...
        try {
            ...
            console.log(
                'Fetching EMS phone and email before deletion...'
            );
            ...
            console.log(
                'STEP 1: Deleting EMS Phone...'
            );

            await deleteEMSMemberPhone(
                phoneData.id
            );

            console.log(
                'STEP 1 SUCCESS: EMS Phone deleted'
            );
            ...
            console.log(
                'STEP 2: Deleting EMS Email...'
            );

            await deleteEMSMemberEmail(
                emailData.id
            );

            console.log(
                'STEP 2 SUCCESS: EMS Email deleted'
            );
            ...
            console.log(
                'STEP 3: Deleting EMS Member...'
            );

            await deleteEMSMember(
                memberId
            );

            console.log(
                'STEP 3 SUCCESS: EMS Member deleted'
            );
            ...
            console.log(
                'STEP 4: Deleting local employee...'
            );
            ...
            if (
                ...
                console.log(
                    'STEP 4 SUCCESS: Local employee deleted'
                );
            ...
            console.error(
                'Employee deletion sequence failed:',
                error
            );
