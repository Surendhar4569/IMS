  ...
  const navItems = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: "assign-admin-group",
          label: "Assign Admin to group",
          icon: (
            <svg
              width="18"
              height="18"
  ...
  return (
    <div className="flex min-h-screen" style={{ background: "#F8F9FC" }}>
          ...
          <nav className="flex-1 p-3 space-y-1">
            {navItems.map((item) => {
              ...
              const isParentActive =
                isBuildingManagement && hasActiveDescendant(item);
              const isIncidentParentActive =
                isIncidentManagement && hasActiveDescendant(item);
              const isSettingsParentActive =
                isSettings && hasActiveDescendant(item);


              const isExpandableParent =
                isBuildingManagement || isIncidentManagement || isSettings;

              const isParentExpanded = isBuildingManagement
                ? buildingManagementOpen
                : isIncidentManagement ? incidentManagementOpen : settingsOpen;

              const setParentExpanded = isBuildingManagement
                ? setBuildingManagementOpen
                : isIncidentManagement ? setIncidentManagementOpen : setSettingsOpen;
              const isAnyParentActive =
                isParentActive || isIncidentParentActive || isSettingsParentActive;
          ...
          <nav className="flex-1 p-4 space-y-1">
            {navItems.map((item) => {
              ...
              const isIncidentParentActive =
                isIncidentManagement && hasActiveDescendant(item);
              const isExpandableParent =
                isBuildingManagement || isIncidentManagement;
              const isParentExpanded = isBuildingManagement
                ? buildingManagementOpen
                : incidentManagementOpen;
              const setParentExpanded = isBuildingManagement
                ? setBuildingManagementOpen
                : setIncidentManagementOpen;
              const isAnyParentActive =
                isParentActive || isIncidentParentActive;
      ...
      >
        ...
        {/* Header */}
        <header
          className="h-16 lg:h-20 bg-white flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 z-10 shadow-sm"
        ...
        >
                              ...
                              : activeTab === "add-incidents"
                                ...
                                : activeTab === "incident-investigations"
                                  ...
                                  : activeTab === "post-incidents-review"
                                    ...
                                    : activeTab === "incident-room-allocation"
                                      ? "Allocate rooms for active incidents"
                                      : ""}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div
              className="lg:hidden w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold"
              style={{ background: "#1A3A6E" }}
            >
              {userName.charAt(0).toUpperCase()}
            </div>
