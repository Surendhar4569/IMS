...
function AdminDashboard({ handleLogout }) {
    ...
    return (
        <div className="flex min-h-screen" style={{ background: '#F8F9FC' }}>
            ...
            >
                <div className="h-full flex flex-col overflow-y-auto" style={{ background: '#0B1D3A' }}>
                        ...
                        {isSidebarExpanded ? (
                            <div className="flex items-center gap-3 w-full">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h1 className="text-white font-bold text-sm tracking-wide">IMS Platform</h1>
                    ...
                    <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
                        {!isSidebarExpanded && (
                            <div className="px-3 pt-2 pb-3 text-[10px] font-semibold uppercase tracking-widest text-center" style={{ color: 'rgba(255,255,255,0.3)' }}>
                                Menu
                            </div>
                        )}
                        {isSidebarExpanded && (
            ...
            {/* Main Content Area */}
            <main className="flex-1 flex flex-col min-h-screen w-full transition-all duration-300 ease-out">
                ...
                <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-auto">
                    <div className="bg-white rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm" style={{ border: '1px solid #EEF0F4' }}>
