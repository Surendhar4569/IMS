...
function Incidents() {
  ...
  const [formTab, setFormTab] = useState("tab1"); // modal tabs: tab1 | tab2
  const [selectedIncident, setSelectedIncident] = useState(null);

  // states for camera
  const [showCamModal, setShowCamModal] = useState(false);
  const [activeCam, setActiveCam] = useState(null); // null means grid view, object means full screen
  ...
  // Focus title input when the add/edit modal opens
  useEffect(() => {
    if (showIncidentModal && formTab === "tab1") {
      try {
  ...
  // ============================================================
  // MODAL OPEN / CLOSE (Employee page structure)
  // ============================================================
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.schedule_type === "SCHEDULE" && !formData.scheduled_at) {
      setFormTab("tab2");
      setMessage({
        type: "error",
  ...
  const handleEdit = (incident) => {
    ...
    setFormData({
      ...
      schedule_type: incident.schedule_type || "IMMEDIATE",
      scheduled_at: incident.scheduled_at
        ? incident.scheduled_at.substring(0, 16)
        : "",
  ...
  const airportCams = [
    { id: 1, name: "Terminal 1 - Main Hall", src: airportVideo4 },
    { id: 2, name: "Gate A12 - Boarding", src: airportVideo1 },
    { id: 3, name: "Baggage Claim", src: airportVideo2 },
    { id: 4, name: "Runway 09L - Approach", src: airportVideo3 },
    { id: 5, name: "Security Checkpoint B", src: airportVideo4 },
    { id: 6, name: "ATC Tower View", src: airportVideo1 },
    { id: 7, name: "Parking Garage L2", src: airportVideo2 },
    { id: 8, name: "Duty Free Shop", src: airportVideo3 },
    { id: 9, name: "Cargo Facility", src: airportVideo4 },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2 bg-[#0B1D3A] text-white rounded-lg text-sm font-semibold hover:bg-[#132D5E] shadow-sm"
                >
        ...
        {/* ============================================================
            ADD / EDIT INCIDENT MODAL (WITH TABS)
        ============================================================ */}
        {showIncidentModal && (
          <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
              {/* Modal Header */}
              <div className="bg-gradient-to-r from-gray-50 to-white px-6 py-5 border-b border-gray-200 flex items-center justify-between flex-shrink-0 rounded-t-2xl">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">
              ...
              <div className="px-6 pt-4 flex-shrink-0">
                <div className="bg-gray-50 rounded-xl border border-gray-200 p-1 flex gap-1">
                  <button
                    type="button"
                    onClick={() => setFormTab("tab1")}
              ...
              {/* Message shown INSIDE the modal so validation errors are visible */}
              {message.text && (
                <div
                  className={`mx-6 mt-4 rounded-xl p-3 flex items-start gap-3 flex-shrink-0 ${
                    message.type === "success"
                      ? "bg-green-50 border border-green-200 text-green-800"
                      : "bg-red-50 border border-red-200 text-red-800"
                  }`}
              ...
              >
                {/* ==================================================
                    TAB 1: INCIDENT INFORMATION + CLASSIFICATION
                ================================================== */}
                {formTab === "tab1" && (
                  <>
                    ...
                    <div className="mb-6">
                      <div className="flex items-center gap-2 mb-4">
                        <Tag className="w-4 h-4 text-[#0B1D3A]" />
                      ...
                      {/* Row 1: Incident Type + Incident Title */}
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-4">
                        <AlertTriangle className="w-4 h-4 text-[#0B1D3A]" />
                        <h3 className="text-xs font-bold text-gray-900 uppercase tracking-wider">
                          Classification
                        </h3>
                        <div className="flex-1 h-px bg-gray-200" />
                      ...
                      {/* Severity Level — Button Group (Full Width) */}
                      <div className="mb-4">
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                          Severity Level
                        </label>
                ...
                {formTab === "tab2" && (
                  <div>
                    <div className="flex items-center gap-2 mb-4">
                      <Clock className="w-4 h-4 text-[#0B1D3A]" />
                      <h3 className="text-xs font-bold text-gray-900 uppercase tracking-wider">
                        Scheduling Details
                      </h3>
                      <div className="flex-1 h-px bg-gray-200" />
                    ...
                    {/* Schedule Type — Button Group (Full Width) */}
                    <div className="mb-4">
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        Schedule Type
                      </label>
                      <div className="flex gap-2">
                        {[
                          ...
                          <button
                            ...
                            className={`flex-1 px-3 py-3 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-1.5 border-2 ${
                              formData.schedule_type === option.value
                                ? "bg-[#0B1D3A] text-white border-[#0B1D3A] shadow-md"
                    ...
                    {/* ==================================================
                        SCHEDULED DATE & TIME
                        Only visible when "Schedule" is selected
                    ================================================== */}
              ...
              <div className="p-4 border-t border-gray-200 flex justify-end gap-3 bg-gray-50 rounded-b-2xl flex-shrink-0">
                <button
                  ...
                  onClick={handleCloseModal}
                  disabled={saving}
                  className="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-50 transition-all disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedIncident.scheduled_at && (
                      <div className="flex items-center gap-3 text-sm">
                        <Calendar className="w-4 h-4 text-gray-400" />
                        <span className="text-gray-500">Scheduled:</span>
                        <span className="font-medium text-gray-900">
                          {formatDate(selectedIncident.scheduled_at)}
                        </span>
                      </div>
                    )}
                  </div>
